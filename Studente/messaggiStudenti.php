...
<head>
    ...
    <style>
        ...
        .test-item {
            width: calc(50% - 20px);
            /* Calcola la larghezza per permettere due box per riga, sottraendo il margine */
            padding: 10px;
            margin-bottom: 20px;
            /* Aumenta il margine inferiore per più spazio tra le righe */
            background-color: #f9f9f9;
            border-radius: 5px;
            box-shadow: 0 0 5px rgba(0, 0, 0, 0.1);
            text-align: left;
            box-sizing: border-box;
            /* Include padding e border nella larghezza del box */
            margin-right: 10px;
            /* Aggiunge spazio tra i box sulla stessa riga */
        }

        /* Utilizza nth-child per rimuovere il margine a destra dal secondo elemento per evitare spaziature disomogenee */
