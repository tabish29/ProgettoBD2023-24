...
CREATE TABLE MESSAGGIO (
    ...
    FOREIGN KEY(TitoloTest) REFERENCES TEST(Titolo) ON UPDATE CASCADE 				-- BOH IO NON SO HO MESSO CASCADE
...
CREATE TABLE RICEZIONESTUDENTE (
	...
	FOREIGN KEY(TitoloTest) REFERENCES TEST(Titolo) ON UPDATE CASCADE,
...
CREATE TABLE QUESITORISPOSTACHIUSA (
    ...
    FOREIGN KEY(TitoloTest) REFERENCES QUESITO(TitoloTest) ON UPDATE CASCADE,
...
CREATE TABLE SOLUZIONE (
   ...
   FOREIGN KEY(TitoloTest) REFERENCES QUESITOCODICE(TitoloTest) ON UPDATE CASCADE,
...
CREATE TABLE OPZIONERISPOSTA (
    ...
    FOREIGN KEY(TitoloTest) REFERENCES QUESITORISPOSTACHIUSA(TitoloTest) ON UPDATE CASCADE,
    FOREIGN KEY(NumeroProgressivoQuesito) REFERENCES QUESITORISPOSTACHIUSA(NumeroProgressivo) ON DELETE CASCADE
